...
threatmodeler.core.threat_examples = cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"file-uploads","file-uploads",-280084287),new cljs.core.Keyword(null,"backup","backup",26347393),new cljs.core.Keyword(null,"content-over-http","content-over-http",819021729),new cljs.core.Keyword(null,"session-fixation","session-fixation",1603298),new cljs.core.Keyword(null,"session-generation","session-generation",-15776764),new cljs.core.Keyword(null,"connected-to-network","connected-to-network",1451896805),new cljs.core.Keyword(null,"third-party-components","third-party-components",516438759),new cljs.core.Keyword(null,"cookies","cookies",1839416329),new cljs.core.Keyword(null,"docker","docker",743480170),new cljs.core.Keyword(null,"tls","tls",67511053),new cljs.core.Keyword(null,"deauthentication","deauthentication",-1016940433),new cljs.core.Keyword(null,"encrypt-or-sign-data","encrypt-or-sign-data",-207053393),new cljs.core.Keyword(null,"db-injection","db-injection",-658610608),new cljs.core.Keyword(null,"cleartext-password-storage","cleartext-password-storage",-1556352112),new cljs.core.Keyword(null,"jwt","jwt",1504015441),new cljs.core.Keyword(null,"xxe","xxe",-178855727),new cljs.core.Keyword(null,"weak-reset-password-flow","weak-reset-password-flow",-695859502),new cljs.core.Keyword(null,"authentication","authentication",1746273042),new cljs.core.Keyword(null,"xxs","xxs",-16722349),new cljs.core.Keyword(null,"race-condition","race-condition",-2009671496),new cljs.core.Keyword(null,"memory-corruption","memory-corruption",-769418887),new cljs.core.Keyword(null,"sensitive-data","sensitive-data",-619043526),new cljs.core.Keyword(null,"machine-learning-taint-data","machine-learning-taint-data",820593114),new cljs.core.Keyword(null,"password-complexity","password-complexity",1503775067),new cljs.core.Keyword(null,"serialization","serialization",-471429060),new cljs.core.Keyword(null,"command-launching","command-launching",1688449820),new cljs.core.Keyword(null,"machine-learning-train-against-model","machine-learning-train-against-model",-1555130721)],[new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Users can upload files.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"If files are saved to disk, perform path canonicalization on files and ensure target file is under expected directory and path. Restrict what type of data can be uploaded. If users can download files, set the appropriate mime-type presenting the data. Avoid allowing executable to be uploaded."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Data is deleted or corrupted.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Perform backups of data."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"User Connects Over HTTP",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Configure HSTS Reloading. Return Strict Transport Security header, and include sub domains. Redirect HTTP to HTTPS."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker forces target user to authentication under an attacker-controlled account. Attackers may modify URLs which accept authentication id/tokens to force authenticate users. Attacker may force users submit login forms to authentication as the attacker too.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Verify authenticator with requests, such as with anti Cross-Site Request Forgery tokens."], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"description","description",-1428560544),"Ensure sessions are generated from a cryptographically secure random number generator, which contain a sufficient amount of entropy, such as 128 bits."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Host is connected to a network, exposing network devices to internet.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Add firewall rules to restrict inbound and output traffic."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker breaks in to system due to vulnerabilites in third party components.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Keep third-party components up to date with latest security patches. Ensure trusted components are used. If untrusted components ar required, consider sandboxing the components from accessing sensitive data."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"User authentications with cookies.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Use cookie security flags to protect information (SameSite,HTTPOnly,Secure)"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Root file system is mounted within docker container, allowing host to be compromised.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Limit file system exposed to docker."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Sensitive data transferred over the network.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Use Transport Layer Security to secure communications. Ensure strong cipher-suites and parameters are used."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"User can't sign out.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Determine appropriate amount of time for sessions to time out. When a user clicks sign out, contact the remote service terminate the user's session. Ensure that the session id/token can't be used supplied to authentication with the remote service."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Weak cryptography is used, allowing communications to be forged or decrypted.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Use a vetted cryptographic library, such as libsodium, which handles cryptographic operations. Avoid implementing own cryptographic routines, as a wide range of attacks against."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Queries are constructed from user data.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"User  queries. Avoid using string concatenation with database queries and user input. Note data may be possible to  be coerced into arrays or hashmaps by the web server. For NoSQL queries, this can lead to injection of inequality statements."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Database contains credentials.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Use a cryptographically secure hashing algorithm to hash passwords, such as scrypt."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"User authentications with JWT",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Ensure algorithm \"none\" is not supported. Ensure users can't mix key material with algorithms (ie, use a public key as HMAC secret.)"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"XML is processed.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Disable Document Type Definition (DTD) parsing and external entity resolving when possible."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker compromise password reset flows through weak processes (reset codes send via SMS, insufficient amount of entropy in reset links, etc.)",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Generate password reset links which contain a large amount of entropy, such as 128 bits."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Session identifiers are used to identify users.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Generation Session IDs form a cryptographically secure source, such as a CSRPNG. Ensure the length of session IDs are not brute-forceable, such as 128 bits of entropy in length."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Application displays user supplied data",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Encode user input for the appropriate context it appears in (HTML, JavaScript, etc.). Configure CORS policies"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker performs multiple operations simultaneously, causing the application to perform unwanted behavior.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"If possible, perform action synchronously to prevent unwanted side-effects. For example, database/memory transactions and locks can be used to prevent sumptuously updating of sensitive data."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Memory corruption/disclosure vulnerability exists, allowing attacker to influence application or access sensitive data.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Use static analysis, such as by leveraging compiler flags, to detect vulnerable code patterns. If possible, avoid or minimize using languages where memory safety is hard to achieve. Whenever possible, use memory-corruption mitigation's such as ASLR, DEP, and Stack Cookies. Perform fuzzing on applications to discover vulnerabilities."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Sensitive Information is stored (PII, Password Hashes etc.)",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Encrypt sensitive data. Use a vetted cryptography library/service when possible, such as libsodium. Ensure the chosen library makes use of strong cryptography (uses non-broken cryptographic algorithm,  generates keys using a CSRPNG, does not re-use IVs, facilities key rotations, etc.)"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker can influence training data.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Review and assign trust-worthiness to data to avoid malicious tainting of data."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Users can specify their own password.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Define a set a password complexity policy."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"User supplied data is deserialized",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Use a secure serialization framework/library which can not be leveraged to deserialize arbitrary types (Ex, Avoid BinaryFormatter in .NET). Validate user supplied data to avoid mass assignment and injection vulnerabilites."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker can influence applications/command arguments.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Whenever possible, don't allow the attacker to specify the actual application to run. Validate and sanitize user input. Do not use string concatenation/formatting to build command strings."], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"description","description",-1428560544),"Attacker uses application to train their own models.",new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626),"Add rate limiting. Returning fuzzy data may be performed."], null)]);
...
var fexpr__39017 = ((cljs.core.contains_QMARK_(input_set,value))?cljs.core.disj:cljs.core.conj);
return (fexpr__39017.cljs$core$IFn$_invoke$arity$2 ? fexpr__39017.cljs$core$IFn$_invoke$arity$2(input_set,value) : fexpr__39017.call(null,input_set,value));
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__39018 = cljs.core.get_global_hierarchy;
return (fexpr__39018.cljs$core$IFn$_invoke$arity$0 ? fexpr__39018.cljs$core$IFn$_invoke$arity$0() : fexpr__39018.call(null));
})());
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__39019 = cljs.core.get_global_hierarchy;
return (fexpr__39019.cljs$core$IFn$_invoke$arity$0 ? fexpr__39019.cljs$core$IFn$_invoke$arity$0() : fexpr__39019.call(null));
})());
...
threatmodeler.core.render_line = (function threatmodeler$core$render_line(p__39020){
...
var line = map__39021__$1;
var x1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"x1","x1",-1863922247));
var y1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"y1","y1",589123466));
var x2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"x2","x2",-1362513475));
var y2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"y2","y2",-718691301));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39021__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
threatmodeler.core.render_threat_model_element_common = (function threatmodeler$core$render_threat_model_element_common(p__39023){
...
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var rotate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"rotate","rotate",152705015));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__39026 = cljs.core.get_global_hierarchy;
return (fexpr__39026.cljs$core$IFn$_invoke$arity$0 ? fexpr__39026.cljs$core$IFn$_invoke$arity$0() : fexpr__39026.call(null));
})());
...
var ui_state_derefed_39054 = cljs.core.deref(threatmodeler.core.ui_state);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(threatmodeler.core.threat_model,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"active-diagram-element-id","active-diagram-element-id",580407382).cljs$core$IFn$_invoke$arity$1(ui_state_derefed_39054)], null),(function (cur_val){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cur_val,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"newX","newX",-90483607).cljs$core$IFn$_invoke$arity$1(ui_state_derefed_39054),new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"newY","newY",-1472730860).cljs$core$IFn$_invoke$arity$1(ui_state_derefed_39054)], null)], 0));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.threat-element-property-groups","div.threat-element-property-groups",-1471481462),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function threatmodeler$core$render_threat_element_property_groups_$_iter__39028(s__39029){
return (new cljs.core.LazySeq(null,(function (){
var s__39029__$1 = s__39029;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__39029__$1);
if(temp__5735__auto__){
var s__39029__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39029__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__39029__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__39031 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__39030 = (0);
while(true){
if((i__39030 < size__4581__auto__)){
var vec__39032 = cljs.core._nth(c__4580__auto__,i__39030);
var group_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39032,(0),null);
var scenario_ids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39032,(1),null);
cljs.core.chunk_append(b__39031,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.checklist-with-header","div.checklist-with-header",656683266),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h5","h5",-1829156625),group_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = ((function (i__39030,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element){
return (function threatmodeler$core$render_threat_element_property_groups_$_iter__39028_$_iter__39035(s__39036){
return (new cljs.core.LazySeq(null,((function (i__39030,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element){
return (function (){
var s__39036__$1 = s__39036;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__39036__$1);
if(temp__5735__auto____$1){
var s__39036__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__39036__$2)){
var c__4580__auto____$1 = cljs.core.chunk_first(s__39036__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__39038 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__39037 = (0);
while(true){
if((i__39037 < size__4581__auto____$1)){
var property = cljs.core._nth(c__4580__auto____$1,i__39037);
cljs.core.chunk_append(b__39038,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(active_element),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__39037,i__39030,property,c__4580__auto____$1,size__4581__auto____$1,b__39038,s__39036__$2,temp__5735__auto____$1,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element){
return (function (){
return threatmodeler.core.toggle_element_property_for_element_BANG_(element_id,property);
});})(i__39037,i__39030,property,c__4580__auto____$1,size__4581__auto____$1,b__39038,s__39036__$2,temp__5735__auto____$1,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39038),threatmodeler$core$render_threat_element_property_groups_$_iter__39028_$_iter__39035(cljs.core.chunk_rest(s__39036__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39038),null);
}
} else {
var property = cljs.core.first(s__39036__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(active_element),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__39030,property,s__39036__$2,temp__5735__auto____$1,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element){
return (function (){
return threatmodeler.core.toggle_element_property_for_element_BANG_(element_id,property);
});})(i__39030,property,s__39036__$2,temp__5735__auto____$1,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"for","for",-1323786319),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property)], null)], null),threatmodeler$core$render_threat_element_property_groups_$_iter__39028_$_iter__39035(cljs.core.rest(s__39036__$2)));
}
} else {
return null;
}
...
});})(i__39030,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element))
,null,null));
});})(i__39030,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element))
;
return iter__4582__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__39030,iter__4582__auto__,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element){
return (function (p1__39027_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(property_groups,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scenarios","scenarios",1618559369),p1__39027_SHARP_], null));
});})(i__39030,iter__4582__auto__,vec__39032,group_name,scenario_ids,c__4580__auto__,size__4581__auto__,b__39031,s__39029__$2,temp__5735__auto__,active_element))
,scenario_ids));
})())], null)], null));

var G__39056 = (i__39030 + (1));
i__39030 = G__39056;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39031),threatmodeler$core$render_threat_element_property_groups_$_iter__39028(cljs.core.chunk_rest(s__39029__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39031),null);
}
} else {
var vec__39039 = cljs.core.first(s__39029__$2);
var group_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39039,(0),null);
var scenario_ids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39039,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.checklist-with-header","div.checklist-with-header",656683266),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h5","h5",-1829156625),group_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = ((function (vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element){
return (function threatmodeler$core$render_threat_element_property_groups_$_iter__39028_$_iter__39042(s__39043){
return (new cljs.core.LazySeq(null,(function (){
var s__39043__$1 = s__39043;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__39043__$1);
if(temp__5735__auto____$1){
var s__39043__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__39043__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__39043__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__39045 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__39044 = (0);
while(true){
if((i__39044 < size__4581__auto__)){
var property = cljs.core._nth(c__4580__auto__,i__39044);
cljs.core.chunk_append(b__39045,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(active_element),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__39044,property,c__4580__auto__,size__4581__auto__,b__39045,s__39043__$2,temp__5735__auto____$1,vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element){
return (function (){
return threatmodeler.core.toggle_element_property_for_element_BANG_(element_id,property);
});})(i__39044,property,c__4580__auto__,size__4581__auto__,b__39045,s__39043__$2,temp__5735__auto____$1,vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"for","for",-1323786319),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property)], null)], null));

var G__39057 = (i__39044 + (1));
i__39044 = G__39057;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39045),threatmodeler$core$render_threat_element_property_groups_$_iter__39028_$_iter__39042(cljs.core.chunk_rest(s__39043__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39045),null);
}
} else {
var property = cljs.core.first(s__39043__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property),new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(active_element),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (property,s__39043__$2,temp__5735__auto____$1,vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element){
return (function (){
return threatmodeler.core.toggle_element_property_for_element_BANG_(element_id,property);
});})(property,s__39043__$2,temp__5735__auto____$1,vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"for","for",-1323786319),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(property)], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(property)], null)], null),threatmodeler$core$render_threat_element_property_groups_$_iter__39028_$_iter__39042(cljs.core.rest(s__39043__$2)));
}
} else {
return null;
}
...
});})(vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element))
;
return iter__4582__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (iter__4582__auto__,vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element){
return (function (p1__39027_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(property_groups,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scenarios","scenarios",1618559369),p1__39027_SHARP_], null));
});})(iter__4582__auto__,vec__39039,group_name,scenario_ids,s__39029__$2,temp__5735__auto__,active_element))
,scenario_ids));
})())], null)], null),threatmodeler$core$render_threat_element_property_groups_$_iter__39028(cljs.core.rest(s__39029__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table#threat-table","table#threat-table",-106845795),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Description"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),"Mitigation"], null)], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function threatmodeler$core$threat_table_$_iter__39046(s__39047){
return (new cljs.core.LazySeq(null,(function (){
var s__39047__$1 = s__39047;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__39047__$1);
if(temp__5735__auto__){
var s__39047__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39047__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__39047__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__39049 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__39048 = (0);
while(true){
if((i__39048 < size__4581__auto__)){
var threat_id = cljs.core._nth(c__4580__auto__,i__39048);
cljs.core.chunk_append(b__39049,(function (){var threat_info = (threatmodeler.core.threat_examples.cljs$core$IFn$_invoke$arity$1 ? threatmodeler.core.threat_examples.cljs$core$IFn$_invoke$arity$1(threat_id) : threatmodeler.core.threat_examples.call(null,threat_id));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39049),threatmodeler$core$threat_table_$_iter__39046(cljs.core.chunk_rest(s__39047__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39049),null);
}
} else {
var threat_id = cljs.core.first(s__39047__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(threat_info)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.Keyword(null,"mitigation","mitigation",-1042940626).cljs$core$IFn$_invoke$arity$1(threat_info)], null)], null);
})(),threatmodeler$core$threat_table_$_iter__39046(cljs.core.rest(s__39047__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39053),threatmodeler$core$simple_example_$_iter__39050(cljs.core.chunk_rest(s__39051__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39053),null);
}
} else {
var element = cljs.core.first(s__39051__$2);
return cljs.core.cons(threatmodeler.core.render_threat_model_element.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(threat_model))),threatmodeler$core$simple_example_$_iter__39050(cljs.core.rest(s__39051__$2)));
}
} else {
return null;
}
