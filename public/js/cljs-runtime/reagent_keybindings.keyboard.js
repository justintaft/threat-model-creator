...
reagent_keybindings.keyboard.modifiers = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__35585){
...
}),new cljs.core.PersistentArrayMap(null, 7, ["shift",(16),"alt",(18),"option",(18),"ctrl",(17),"control",(17),"cmd",(91),"command",(91)], null),(function (){var iter__4582__auto__ = (function reagent_keybindings$keyboard$iter__35589(s__35590){
return (new cljs.core.LazySeq(null,(function (){
var s__35590__$1 = s__35590;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__35590__$1);
if(temp__5735__auto__){
var s__35590__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__35590__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__35590__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__35592 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__35591 = (0);
while(true){
if((i__35591 < size__4581__auto__)){
var k = cljs.core._nth(c__4580__auto__,i__35591);
cljs.core.chunk_append(b__35592,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["f",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join(''),((111) + k)], null));

var G__35612 = (i__35591 + (1));
i__35591 = G__35612;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__35592),reagent_keybindings$keyboard$iter__35589(cljs.core.chunk_rest(s__35590__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__35592),null);
}
} else {
var k = cljs.core.first(s__35590__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["f",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join(''),((111) + k)], null),reagent_keybindings$keyboard$iter__35589(cljs.core.rest(s__35590__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__35597),reagent_keybindings$keyboard$string_to_keys_STAR__$_iter__35594(cljs.core.chunk_rest(s__35595__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__35597),null);
}
} else {
var k = cljs.core.first(s__35595__$2);
return cljs.core.cons(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((16),k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shift","shift",997140064),true], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((17),k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ctrl","ctrl",361402094),true], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((18),k))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"alt","alt",-3214426),true], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"keycode","keycode",-47989070),k], null)
))),reagent_keybindings$keyboard$string_to_keys_STAR__$_iter__35594(cljs.core.rest(s__35595__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(cljs.core.some((function (p1__35598_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__35598_SHARP_),id);
}),action_coll))){
return cljs.core.vec((function (){var iter__4582__auto__ = (function reagent_keybindings$keyboard$register_keys_BANG__$_iter__35599(s__35600){
return (new cljs.core.LazySeq(null,(function (){
var s__35600__$1 = s__35600;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__35600__$1);
if(temp__5735__auto__){
var s__35600__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__35600__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__35600__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__35602 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__35601 = (0);
while(true){
if((i__35601 < size__4581__auto__)){
var entry = cljs.core._nth(c__4580__auto__,i__35601);
cljs.core.chunk_append(b__35602,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(entry)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entry,new cljs.core.Keyword(null,"action-fn","action-fn",1914929011),action_fn):entry));

var G__35614 = (i__35601 + (1));
i__35601 = G__35614;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__35602),reagent_keybindings$keyboard$register_keys_BANG__$_iter__35599(cljs.core.chunk_rest(s__35600__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__35602),null);
}
} else {
var entry = cljs.core.first(s__35600__$2);
return cljs.core.cons(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(entry)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entry,new cljs.core.Keyword(null,"action-fn","action-fn",1914929011),action_fn):entry),reagent_keybindings$keyboard$register_keys_BANG__$_iter__35599(cljs.core.rest(s__35600__$2)));
}
} else {
return null;
}
...
var keys_map = reagent_keybindings.keyboard.string_to_keys(shortcut_string);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(reagent_keybindings.keyboard.registered_keys,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [keys_map], null),(function (action_coll){
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__35603_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__35603_SHARP_),id);
}),action_coll));
}));
});
/**
...
var temp__5735__auto___35615 = reagent_keybindings.keyboard.get_keys_action(pressed_keys);
if(cljs.core.truth_(temp__5735__auto___35615)){
var action_35616 = temp__5735__auto___35615;
(action_35616.cljs$core$IFn$_invoke$arity$1 ? action_35616.cljs$core$IFn$_invoke$arity$1(evt) : action_35616.call(null,evt));
...
var keycode = (function (){var pred__35604 = cljs.core._EQ_;
var expr__35605 = button;
if(cljs.core.truth_((pred__35604.cljs$core$IFn$_invoke$arity$2 ? pred__35604.cljs$core$IFn$_invoke$arity$2((0),expr__35605) : pred__35604.call(null,(0),expr__35605)))){
return new cljs.core.Keyword(null,"m0","m0",-1497854839);
} else {
if(cljs.core.truth_((pred__35604.cljs$core$IFn$_invoke$arity$2 ? pred__35604.cljs$core$IFn$_invoke$arity$2((1),expr__35605) : pred__35604.call(null,(1),expr__35605)))){
return new cljs.core.Keyword(null,"m1","m1",-108094626);
} else {
if(cljs.core.truth_((pred__35604.cljs$core$IFn$_invoke$arity$2 ? pred__35604.cljs$core$IFn$_invoke$arity$2((2),expr__35605) : pred__35604.call(null,(2),expr__35605)))){
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (_,p__35607){
var vec__35608 = p__35607;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35608,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35608,(1),null);
var new_kb_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35608,(2),null);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(reagent_keybindings.keyboard.deactivate_shortcuts_comps,(function (p1__35611_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.createAsIfByAssoc([id]),p1__35611_SHARP_);
}));
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (_){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991)], null);
})], null));
